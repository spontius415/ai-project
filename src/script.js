...
function generatePoem(event) {
  ...
  let context =
    "You are an AI assistant and a poem generator. You love to write short poems. Your mission is to generate a 4 line poem in basic HTML. Make sure to follow the user instructions.";
